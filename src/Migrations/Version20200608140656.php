 ...
 */
final class Version20200608140656 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cours DROP id_matiere, CHANGE lien_telechargement lien_telechargement VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cours ADD id_matiere INT NOT NULL, CHANGE lien_telechargement lien_telechargement VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
